...
Petite exemple des différentes méthodes qui existent pour la classe String
Cette classe permet beaucoup de possibilités lorsqu'on travaille avec du texte
On peut remplacer des mots/lettres, extraire un caractère, joindre ou couper...
*/
